...
public class question3 extends AppCompatActivity {
    ...
    CountDownTimer timer = new CountDownTimer(milliseconds, 1000) {
        ...
        public void onFinish() {
            ...
            ViewCompat.setBackgroundTintList(correct, ContextCompat.getColorStateList(question3.this, R.color.green));
            Toast.makeText(question3.this, "We made it here", Toast.LENGTH_SHORT).show();
            nextQuestion();
        }
    };
